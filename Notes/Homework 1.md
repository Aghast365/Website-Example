...
10. $A = \lbrace10,20,30\rbrace, B = \lbrace8, 9, 10, 11, 12\rbrace$
	- Exists injection but no surjection or bijection
11. $A = \lbrace10, 73\rbrace, B = \lbrace9,109\rbrace$
	- Exists injection, surjection, and bijection
12. $A= \lbrace12,8,7,6\rbrace,B=\lbrace4,3,2\rbrace$
...
13. $\mathbf N \cup \lbrace(1,1)\rbrace$  
```python
...
```
14. $\mathbf N \cup \lbrace(1,1),\ldots,(1,20)\rbrace$
```python
